...
def run_consistency_checks():
    ...
    ana_list_activity_set = set((event["event_id"], event["trace_id"]) for event in ana_list_activity.json())
    stor_list_beach_set = set((event["event_id"], event["trace_id"]) for event in stor_list_beach.json())
